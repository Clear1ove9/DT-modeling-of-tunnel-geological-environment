...
# 初始化高斯过程分类模型
gpc = GaussianProcessClassifier(kernel=kernel, optimizer='fmin_l_bfgs_b', n_restarts_optimizer=10, random_state=42)

# 训练模型
gpc.fit(X_train_scaled, y_train)

# 保存模型为.model格式
model_filename = 'Water_intensity_TSP&TEM.model'
joblib.dump(scaler, 'Water_intensity_TSP&TEM_scaler.model')
